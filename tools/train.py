...
# Edited by Anay Majee (anaymajee11us@gmail.com)
# ------------------------------------------------------------------------------
...
def main():
    ...
    isKFold = True
    cross_train_set = get_img_Ids('data/tiger/annotations/person_keypoints_train.json')
...
def kfold_split_generate(train_set):
    from sklearn.model_selection import KFold

    kf = KFold(n_splits=5)  #Create 5 splits for the Tiger dataset
    train, test = kf.split(train_set)
